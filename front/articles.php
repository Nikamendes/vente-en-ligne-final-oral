        ...
        <div class="article-container">
            <div class="article-image">
                ...
                <?php } elseif ($article['id'] == 3) { ?>
                    <img src="https://www.pricefactory.fr/509-large_default/ensemble-table-et-chaises-table-160-cm-4-chaises-lina-table-pour-salle-a-manger-laquee-blanche-et-noire-avec-4-chaises.jpg" alt="Table et chaises" style="width: 100%; height: 100%;">
                <?php } ?>
            </div>
